...
namespace Twilio
{
    public partial class TwilioRestClient
    {
        ...
        public virtual async Task<AuthorizedConnectApp> GetAuthorizedConnectAppAsync(string authorizedConnectAppSid)
        {
        ...
        /// </summary>
        public virtual async Task<AuthorizedConnectAppResult> ListAuthorizedConnectAppsAsync()
        {
            return await ListAuthorizedConnectAppsAsync(null, null);
        }
