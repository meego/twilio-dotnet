...
namespace Twilio.TaskRouter
{
    public partial class TaskRouterClient
    {
        ...
        public virtual async Task<TaskQueueStatistics> GetTaskQueueStatisticsAsync(string workspaceSid, string taskQueueSid, StatisticsRequest options)
        {
            ...
            request.Resource = "Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/TaskQueues/{TaskQueueSid}/Statistics";
        ...
        public virtual async Task<TaskQueueStatisticsResult> ListTaskQueuesStatisticsAsync(string workspaceSid)
        {
            return await ListTaskQueuesStatisticsAsync(workspaceSid, new TaskQueuesStatisticsRequest());
        }
        ...
        public virtual async Task<TaskQueueStatisticsResult> ListTaskQueuesStatisticsAsync(string workspaceSid, TaskQueuesStatisticsRequest options)
        {
            ...
            var request = new RestRequest();
            request.Resource = "Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/TaskQueues/Statistics";
