...
namespace Twilio.TaskRouter
{
    public partial class TaskRouterClient
    {
        ...
        public virtual async Task<Reservation> GetReservationAsync(string workspaceSid, string taskSid, string reservationSid)
        {
            ...
            request.Resource = "Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/Tasks/{TaskSid}/Reservations/{ReservationSid}";

            request.AddUrlSegment("WorkspaceSid", workspaceSid);
            request.AddUrlSegment("TaskSid", taskSid);
            request.AddUrlSegment("ReservationSid", reservationSid);

            return await Execute<Reservation>(request);
        }
        ...
        public virtual async Task<ReservationResult> ListReservationsAsync(string workspaceSid, string taskSid)
        {
            return await ListReservationsAsync(workspaceSid, taskSid, null, null, null, null, null);
        }
        ...
        public virtual async Task<ReservationResult> ListReservationsAsync(string workspaceSid, string taskSid, string status, string assignmentStatus, string afterSid, string beforeSid, int? count)
        {
            //Require.Argument("WorkspaceSid", workspaceSid);
            //Require.Argument("TaskSid", taskSid);

            var request = new RestRequest();
            request.Resource = "Accounts/{AccountSid}/Workspaces/{WorkspaceSid}/Tasks/{TaskSid}/Reservations";
            ...
            return await Execute<ReservationResult>(request);
        }
        ...
        public virtual async Task<Reservation> UpdateReservationAsync(string workspaceSid, string taskSid, string reservationSid, string reservationStatus, string workerActivitySid)
        {
            //Require.Argument("WorkspaceSid", workspaceSid);
            //Require.Argument("TaskSid", taskSid);
            //Require.Argument("ReservationSid", reservationSid);
