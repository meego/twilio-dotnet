...
namespace Twilio
{
    ...
    public partial class TwilioRestClient
    {
        ...
        {
            return await _client.ExecuteAsync<RestRequest>(request);
        }

        public virtual async Task<RestResponse> Execute(RestRequest request, CancellationToken cancellationToken) 
        {
            return await _client.ExecuteAsync<RestRequest>(request, cancellationToken);
        }
