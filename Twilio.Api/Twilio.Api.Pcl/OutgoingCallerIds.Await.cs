...
namespace Twilio
{
    public partial class TwilioRestClient
    {
        ...
        public virtual async Task<OutgoingCallerId> GetOutgoingCallerIdAsync(string outgoingCallerIdSid)
        {
        ...
        /// </summary>
        public virtual async Task<OutgoingCallerIdResult> ListOutgoingCallerIdsAsync()
        {
            return await ListOutgoingCallerIdsAsync(null, null, null, null);
        }
        ...
        /// <returns></returns>
        public virtual async Task<OutgoingCallerIdResult> ListOutgoingCallerIdsAsync(string phoneNumber, string friendlyName, int? pageNumber, int? count)
        {
            var request = new RestRequest();
        ...
        public virtual async Task<ValidationRequestResult> AddOutgoingCallerIdAsync(string phoneNumber, OutgoingCallerIdOptions options)
        {
        ...
        public virtual async Task<OutgoingCallerId> UpdateOutgoingCallerIdNameAsync(string outgoingCallerIdSid, string friendlyName)
        {
        ...
        public virtual async Task<DeleteStatus> DeleteOutgoingCallerIdAsync(string outgoingCallerIdSid)
        {
            Require.Argument("OutgoingCallerIdSid", outgoingCallerIdSid);
