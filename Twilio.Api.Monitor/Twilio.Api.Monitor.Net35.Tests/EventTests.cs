...
namespace Twilio.Monitor.Tests
{
    ...
    public class EventTests
    {
        ...
        {
            RestRequest savedRequest = null;
            mockClient.Setup(trc => trc.ExecuteAsync<Event>(It.IsAny<RestRequest>(), It.IsAny<Action<Event>>()))
                .Callback<RestRequest, Action<Event>>((request, action) => savedRequest = request);
            var client = mockClient.Object;
            ...
            mockClient.Verify(trc => trc.ExecuteAsync<Event>(It.IsAny<RestRequest>(), It.IsAny<Action<Event>>()), Times.Once);
            Assert.IsNotNull(savedRequest);
            Assert.AreEqual("Events/{EventSid}", savedRequest.Resource);
            Assert.AreEqual("GET", savedRequest.Method);
            Assert.AreEqual(1, savedRequest.Parameters.Count);
        ...
        {
            RestRequest savedRequest = null;
            mockClient.Setup(trc => trc.ExecuteAsync<EventResult>(It.IsAny<RestRequest>(), It.IsAny<Action<EventResult>>()))
                .Callback<RestRequest, Action<EventResult>>((request, action) => savedRequest = request);
            var client = mockClient.Object;
            manualResetEvent = new ManualResetEvent(false);
            ...
            mockClient.Verify(trc => trc.ExecuteAsync<EventResult>(It.IsAny<RestRequest>(), It.IsAny<Action<EventResult>>()), Times.Once);
            Assert.IsNotNull(savedRequest);
            Assert.AreEqual("Events", savedRequest.Resource);
            Assert.AreEqual("GET", savedRequest.Method);
            Assert.AreEqual(0, savedRequest.Parameters.Count);
