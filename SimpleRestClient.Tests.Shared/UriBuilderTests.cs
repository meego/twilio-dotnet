...
namespace SimpleRestClient.Tests
{
    ...
    {
        private const string BASE_URL = "http://twilio.com";

        [Test]
        public void GET_with_leading_slash()
        {
            var expected = new Uri(BASE_URL + "/resource");
        ...
        {
            var expected = new Uri(BASE_URL + "/resource?foo=bar");
        ...
        [Test]
        public void GET_with_trailing_slash_and_query_parameters()
        {
            var expected = new Uri(BASE_URL + "/resource/?foo=bar");
        ...
        {
            var expected = new Uri(BASE_URL + "/resource/foo");
        ...
        {
            var expected = new Uri(BASE_URL + "/resource/bar");
        ...
        public void GET_with_empty_request()
        {
            ...
            var output = Simple.UriBuilder.Build(BASE_URL + "/resource", request);
        ...
        {
            var expected = new Uri(BASE_URL + "/v1/people/~/network/updates?type=STAT&type=PICT&count=50&start=50");
